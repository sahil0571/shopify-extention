<template>
  <div v-if="this.thankyouModalShow">
    <div>
      <div style="height: 500px;">
        <div><button
            class="Polaris-Button"
            type="button"
          ><span class="Polaris-Button__Content"><span class="Polaris-Button__Text">Open</span></span></button></div>
      </div>
                ...
                >
                  <div class="Polaris-Modal-Dialog__Modal">
                    <div class="Polaris-Modal-Header">
                      ...
                      >
                        <h2 class="Polaris-DisplayText Polaris-DisplayText--sizeSmall">Yay! 🥳🎉</h2>
                      </div><button
                        ...
                        <section class="Polaris-Modal-Section">
                             <div class="text-center">
                              <div class="mb_-2 mt-2 ">
                                <h1 class="fw-500 c-green">Yay! Everything Is Up & Running! 🎉p</h1>
                              </div>
                              <div class="f-22 lh-32">
                                <br>
                                Enjoy the app! <br>
                                <u> Keep the app installed </u> in order to keep the added Pixel in<br>
                                your store. 😄 <br>
                                <PButton primary @click="hideThankyou()">Done</PButton>
                              </div>
                            </div>
                        </section>
                      </div>
...
<script>
export default {
    props : ['thankyouModalShow'],
    methods : {
        hideThankyou(){
            this.$parent.thankyouModalShow = false;
        }
    }
};
</script>